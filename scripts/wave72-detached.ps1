...
$logFile = "C:\Users\Administrator.DESKTOP-EGNE9ND\Agent-Skills-Hub\logs\wave72-detached.log"
$endMarker = "###END###"
...
$repos = @(
    ...
    "robzilla1738/htmlshop","sukilll/prompt-improver","yuhaoliu7456/pdf2md-skill"
)
...
foreach ($repo in $repos) {
    ...
    & npx skills add $repo 2>&1 | Out-Null
...
"=== Wave72 DONE: OK=$ok FAIL=$fail ===" | Out-File -FilePath $logFile -Append -Encoding ascii
